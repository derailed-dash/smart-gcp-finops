...
def test_execute_cached_bigquery_sql_no_restriction(mock_execute_query, mock_bq_client, mock_settings):
    ...
    try:
        ...
        res = execute_cached_bigquery_sql(sql)
...
@patch("app.app_utils.tools.execute_cached_query")
def test_execute_cached_bigquery_sql_with_restriction(mock_execute_query, mock_bq_client, mock_settings):
...
@patch("app.app_utils.tools.execute_cached_query")
def test_execute_cached_bigquery_sql_empty_allowed_projects(mock_execute_query, mock_bq_client, mock_settings):
...
@patch("app.app_utils.tools.execute_cached_query")
def test_execute_cached_bigquery_sql_agent_vs_user_visibility(mock_execute_query, mock_bq_client, mock_settings):
    ...
    try:
        ...
        execute_cached_bigquery_sql(sql)
