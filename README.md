...
> *   **Root [pyproject.toml](file:///home/dazbo/localdev/smart-gcp-finops/pyproject.toml)**: Governs the BFF (Backend-for-Frontend) container, serving FastAPI, Uvicorn, and client SDKs on Cloud Run.
